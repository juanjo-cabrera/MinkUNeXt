    ...
    for i in range(len(query_sets)):
        for j in range(len(query_sets)):
            ...
            if not PARAMS.save_visual_results:
                ...
                csv_file = PARAMS.dataset_folder + '/VISUAL_RESULTS_MinkUNeXt_baseline_USyd/' + parent_dir + '.csv'
...
if __name__ == "__main__":
    ...
    save_eval_stats(stats, '/media/arvc/DATOS/Juanjo/Datasets/benchmark_datasets/stats/MinkUNeXt_baseline_eval_stats_usyd.pickle')
