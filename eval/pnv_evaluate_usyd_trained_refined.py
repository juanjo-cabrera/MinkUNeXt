    ...
    for i in range(len(query_sets)):
        for j in range(len(query_sets)):
            ...
            if not PARAMS.save_visual_results:
                ...
                csv_file = PARAMS.dataset_folder + '/VISUAL_RESULTS_MinkUNeXt_refined_USyd/' + parent_dir + '.csv'
...
if __name__ == "__main__":
    ...
    PARAMS.protocol = 'usyd'
    PARAMS.dataset_folder = '/media/arvc/DATOS/Juanjo/Datasets/USyd/'
    PARAMS.quantization_size = 0.1
    
    # PARAMS.weights_path = '/media/arvc/DATOS/Juanjo/weights/MinkUNeXt/baseline_antonio/MinkUNeXt_baseline_0.01_20250917_0417_best.pth' #'/home/arvc/Juanjo/develop/MinkUNeXt-clean/weights/MinkUNeXt_usyd_0.1_20250918_2327_best.pth' #'/home/arvc/Juanjo/develop/MinkUNeXt-clean/weights/MinkUNeXt_usyd_0.1_20250917_1735_final.pth'
    
    # REFINADO
    PARAMS.weights_path = '/home/arvc/Juanjo/develop/MinkUNeXt/weights/model_MinkUNeXt_refined.pth'
    ...
    save_eval_stats(stats, '/media/arvc/DATOS/Juanjo/Datasets/benchmark_datasets/stats/MinkUNeXt_refined_eval_stats_usyd.pickle')
